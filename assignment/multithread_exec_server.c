...
void write_to_file(int client_sock, const char *client_addr, const char *cmd, const char *result)
{
...
void *client_thread(void *arg)
{
    ...
    const char *welcome = "Multi-threaded Command Execution Server\nType 'exit' to disconnect.\n";
    ...
    while (1)
    {
        ...
        if (!fp)
        {
            ...
            write_to_file(client_sock, client_addr, cmd, "ERROR: Failed to execute command\n");
            continue;
        }
...
int main()
{
    ...
    while (!stop_server)
    {
        ...
        {
            const char *msg = "Server is full. Maximum clients reached. Try again later.\n";
